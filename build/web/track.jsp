...
<%@page import="model.CountUserComplaint"%>
...
<body>
    ...
    <div class="hero">
        <div>
          ...
          <%
        CountUserComplaint total_data = new CountUserComplaint();
        ArrayList<Integer> total = new ArrayList<>();
        total = total_data.Complaints(username);
...
//        DTO user = new DTO();
    ...
    <div class="card">
      ...
      <strong class="text">Username :</strong> <%=username %> <br>
      <strong class="text">Request Time :</strong> <%=request_time %><br>
      <strong class="text">Request Type :</strong> <%=request_type%><br>
      <strong class="text">Location :</strong> <%=location%><br>
      <strong class="text">Status :</strong> <%=status %><br>
...
<!--we can add feature to contact using button or link-->
      </form>
    </div>
    <%
        }
