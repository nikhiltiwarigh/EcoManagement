...
<body>
    ...
    <section class="features">
        ...
        <div class="feature-card">
            <img src="images/garbage.png" alt="Report">
            <h3>Upload Garbage Image</h3>
            <form action="ImageChecker" method="post">
                <input class="file" type="file" name="image" required="">
                <input style="margin-top: 5px" type="text" name="location" placeholder="Enter Proper Location" required="">
        ...
        <div class="feature-card">
            <img src="images/pipelekage.png" alt="Report">
            <h3>Upload Pipe Leakage Image</h3>
            <form action="ImageChecker_Pipeline" method="post">
