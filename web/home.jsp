...
<body>
    ...
    <div class="hero">
        <div>
            <h1 class="name">Welcome <%= name %></h1>
            <h2>Join the Movement for a Cleaner Environment</h2>
            <p>Report issues, track progress, and make a difference in your community!</p>
        </div>
    </div>
    ...
    <section class="features">
        ...
        <div class="feature-card">
            <img src="https://cdn-icons-png.flaticon.com/512/992/992651.png" alt="Track">
            <h3>Report Issues</h3>
            <p>Upload images of waste and water leaks to notify the authorities.</p>
        </div>
        </a>
        <a href="track.jsp">
        <div class="feature-card">
            <img src="https://cdn-icons-png.flaticon.com/512/684/684908.png" alt="Report">
            <h3>Track Progress</h3>
            <p>Track the status of reported issues and see real-time updates.</p>
        </div>
        </a>
        <a href="waste_info.jsp">
        <div class="feature-card">
            <img src="https://cdn-icons-png.flaticon.com/512/438/438531.png" alt="Awareness">
            <h3>Raise Awareness</h3>
            <p>Learn more about recycling, waste management, and sustainability.</p>
        </div>
        </a>
    </section>
    
    <iframe class="ad" src="https://www.wikipedia.org/"></iframe><br><br>
